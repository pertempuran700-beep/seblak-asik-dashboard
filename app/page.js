...
export default function OverviewDashboard() {
  ...
  // Menarik Data Utama dari API Google Sheets
  ...
  // 3. KALKULASI TARGET PROPORSIONAL (Dari Tab Settings)
  ...
  // 4. PERSENTASE PENCAPAIAN TARGET
  ...
  // 5. DATA UNTUK GRAFIK LINE REVENUE
  ...
  return (
    // Menggunakan Padding standar container agar menyatu harmonis dengan Layout Asli Next.js Anda
    <div className="space-y-6 w-full pb-10">
      
      {/* HEADER UTAMA & TOMBOL FILTER WAKTU */}
      ...
      {/* BLOK GRAFIK TRADING LINE REVENUE */}
      ...
      <Card title="📋 Laporan Performa Produk Terjual (Kuantitas)">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-surface2 p-4 rounded-lg border border-border/50">
            <h3 className="font-bold text-info mb-3 flex items-center gap-2">🧊 Produk Terndah (Worst Seller)</h3>
            <ul className="space-y-2">
