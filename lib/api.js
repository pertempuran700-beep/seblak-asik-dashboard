...
async function callApi(action, params = {}) {
  ...
  // 🔥 PERBAIKAN AJAIB: Baca sebagai text dulu, jangan langsung di-JSON-kan!
  ...
  try {
    ...
    // Jika gagal di-parse (artinya server Vercel membalas pakai HTML/DOCTYPE 504 Timeout)
    throw new Error(`Koneksi Server Terputus (Error ${res.status}: Gateway Timeout)`);
  }
