...
export const api = {
  ...
  addWasteProduct: (productId, quantity, notes) => callApi('addWasteProduct', { productId, quantity, notes }),
  ...
  createOtherCostExpense: (itemId, amount, notes) => callApi('createOtherCostExpense', { itemId, amount, notes }),
